...
public class BoardView extends View {
    ...
    private void getGame(GameActivity context) {
    ...
    public void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        int yOffset = (int) ((Global.windowHeight - ((3 * radius / 2) * (game.gamePiece[0].length - 1) + 2 * radius)) / 2);
