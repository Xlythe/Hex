        ...
        if(team == 1) {
            ...
            for(int i = 0; i < game.gameOptions.gridSize; i++) {
                if(RegularPolygonGameObject.checkWinTeam((byte) 1, game.gameOptions.gridSize, i, game.gamePiece)) {
                    ...
                    String path = RegularPolygonGameObject.findShortestPath((byte) 1, game.gameOptions.gridSize, i, game.gamePiece);
                    RegularPolygonGameObject.colorPath(game.gameOptions.gridSize, i, path, game);
                    return true;
                }
            }
            return false;
            ...
            for(int i = 0; i < game.gameOptions.gridSize; i++) {
                if(RegularPolygonGameObject.checkWinTeam((byte) 2, i, game.gameOptions.gridSize, game.gamePiece)) {
                    ...
                    checkedFlagReset(game);
                    String path = RegularPolygonGameObject.findShortestPath((byte) 2, i, game.gameOptions.gridSize, game.gamePiece);
                    RegularPolygonGameObject.colorPath(i, game.gameOptions.gridSize, path, game);
                    return true;
                }
            }
            return false;
