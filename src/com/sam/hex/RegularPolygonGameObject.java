...
public class RegularPolygonGameObject {
    ...
    public void setTeam(byte t, Game game) {
        teamNumber = t;
        if(teamNumber == 1) setColor(game.player1.getColor());
        else if(teamNumber == 2) setColor(game.player2.getColor());
    ...
    public boolean checkpiece(byte team, int x, int y, RegularPolygonGameObject[][] gamePeace) { // used
                                                                                                 // for
                                                                                                 // checking
                                                                                                 // victory
                                                                                                 // conditions
    ...
    public static boolean checkWinTeam(byte team, int x, int y, RegularPolygonGameObject[][] gamePeace) { // used
                                                                                                          // for
                                                                                                          // checking
                                                                                                          // victory
                                                                                                          // condition
    ...
    public String checkpieceShort(byte team, int x, int y, RegularPolygonGameObject[][] gamePeace) { // used
                                                                                                     // for
                                                                                                     // checking
                                                                                                     // victory
                                                                                                     // condition
    ...
    public static String findShortestPath(byte team, int x, int y, RegularPolygonGameObject[][] gamePeace) { // used
                                                                                                             // for
                                                                                                             // checking
                                                                                                             // victory
                                                                                                             // condition
    ...
    static int findShortestString(String[] paths, int lo, int hi) { // used for
                                                                    // checking
                                                                    // victory
                                                                    // condition
        if((lo == hi)) {
    ...
    private static int stringL(String temp) { // used for checking victory
                                              // condition
