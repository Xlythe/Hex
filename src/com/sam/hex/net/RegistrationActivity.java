        ...
        enter.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ParsedDataset parsedDataset = igGameCenter.register(username.getText().toString(), password.getText().toString(), email.getText()
                                    .toString());
                            if(!parsedDataset.error) {
                                ...
                                Looper.prepare();
                                new AlertDialog.Builder(RegistrationActivity.this).setMessage(parsedDataset.getErrorMessage())
                                        .setNeutralButton(RegistrationActivity.this.getString(R.string.okay), null).show();
                                Looper.loop();
                            }
                        }
