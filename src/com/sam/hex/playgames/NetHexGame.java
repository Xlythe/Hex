...
public class NetHexGame extends BaseGameActivity {
    ...
    // if(game.gameOver)
    // game.gameListener.onWin(GameAction.getPlayer(game.currentPlayer, game));
    //
    ...
    // go.timer = new Timer(Integer.parseInt(prefs.getString("timerPref", "0")),
    // 0, timerType);
    //
    ...
    // @Override
    // public void run() {
    // String winnerMsg = GameAction.insert(getString(R.string.winner),
    // player.getName());
    ...
    // @Override
    // public void run() {
    // timerText.setText(GameAction.insert(getString(R.string.timer),
    ...
    // * */
    // public void setNames(SharedPreferences prefs, int gameLocation, Game
    // game) {
    ...
    // * */
    // public void setColors(SharedPreferences prefs, int gameLocation, Game
    // game) {
    // if(gameLocation == GameAction.LOCAL_GAME) {
    // // Playing on the same phone
    // game.player1.setColor(prefs.getInt("player1Color",
    // getResources().getInteger(R.integer.DEFAULT_P1_COLOR)));
    // game.player2.setColor(prefs.getInt("player2Color",
    // getResources().getInteger(R.integer.DEFAULT_P2_COLOR)));
    // }
    // else if(gameLocation == GameAction.NET_GAME) {
    // // Playing on the net
    ...
    // if(gameLocation == GameAction.LOCAL_GAME) {
    // // Playing on the same phone
    // gridSize = Integer.valueOf(prefs.getString("gameSizePref",
    // getString(R.integer.DEFAULT_BOARD_SIZE)));
    // if(gridSize == 0) gridSize =
    // Integer.valueOf(prefs.getString("customGameSizePref",
    // getString(R.integer.DEFAULT_BOARD_SIZE)));
    // }
    // else if(gameLocation == GameAction.NET_GAME) {
    // // Playing over the net
    ...
    // {
    // if(gameLocation == GameAction.LOCAL_GAME) {
    // game.player1Type = (byte) Integer.parseInt(prefs.getString("player1Type",
    // "1"));
    // game.player2Type = (byte) Integer.parseInt(prefs.getString("player2Type",
    // "0"));
    // }
    // else if(gameLocation == GameAction.NET_GAME) {
    // // // Playing over the net
    ...
    // else if(game.player1Type == 4) game.player1 = new BeeGameAI(1,
    // game.gameOptions.gridSize);
    // }
    //
    ...
    // // game, new Handler(), newgame);
    // else if(game.player2Type == 4) game.player2 = new BeeGameAI(2,
    // game.gameOptions.gridSize);
    // }
    //
    // private void undo() {
    ...
    // builder.setMessage(getString(R.string.confirmNewgame)).setPositiveButton(getString(R.string.yes),
    // dialogClickListener)
    ...
    // * */
    // public boolean somethingChanged(SharedPreferences prefs, int
    // gameLocation, Game game) {
    // if(game == null) return true;
    // if(game.gameOptions.gridSize == 1) return true;
    // if(gameLocation == GameAction.LOCAL_GAME) {
    // return (Integer.valueOf(prefs.getString("gameSizePref",
    // getString(R.integer.DEFAULT_BOARD_SIZE))) != game.gameOptions.gridSize &&
    // Integer
    // .valueOf(prefs.getString("gameSizePref",
    // getString(R.integer.DEFAULT_BOARD_SIZE))) != 0)
    // || (Integer.valueOf(prefs.getString("customGameSizePref",
    // getString(R.integer.DEFAULT_BOARD_SIZE))) != game.gameOptions.gridSize &&
    // Integer
    // .valueOf(prefs.getString("gameSizePref",
    // getString(R.integer.DEFAULT_BOARD_SIZE))) == 0)
    // || Integer.valueOf(prefs.getString("player1Type",
    // getString(R.integer.DEFAULT_P1_ENTITY))) != game.player1Type
    // || Integer.valueOf(prefs.getString("player2Type",
    // getString(R.integer.DEFAULT_P2_ENTITY))) != game.player2Type
    // || Integer.valueOf(prefs.getString("timerTypePref",
    // getString(R.integer.DEFAULT_TIMER_TYPE))) != game.gameOptions.timer.type
    // || Integer.valueOf(prefs.getString("timerPref",
    // getString(R.integer.DEFAULT_TIMER_TIME))) * 60 * 1000 !=
    // game.gameOptions.timer.totalTime;
    // }
    // else if(gameLocation == GameAction.NET_GAME) {
    ...
    //
    // AlertDialog.Builder builder = new AlertDialog.Builder(this);
    // builder.setMessage(getString(R.string.confirmExit)).setPositiveButton(getString(R.string.yes),
    // dialogClickListener)
    // .setNegativeButton(getString(R.string.no), dialogClickListener).show();
    // }
